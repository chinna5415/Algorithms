...
INSERT INTO PAT_ENTRY (PAT_NO VARCHAR(8), PAT_NAME VARCHAR(25), CHKUP_DT DATETIME, PT_AGE NUMERIC(3),
SEX VARCHAR(1), RFRG_CSTNT VARCHAR(25), DIAGNOSIS VARCHAR(50), RFD VARCHAR(1), ADDRESS, CITY, PH_NO, DEPARTMENT)
...
INSERT INTO PAT_CHKUP VALUES('PT001','DR001','CRACK IN ANKLE BONE', 'SERIOUS', 'PLASTER');

INSERT INTO PAT_ADMIT VALUES ('PT001', '150000', 'CASH', 'RN001', 'Cardiology','05/02/2009',
'SERIOUS','LEAKAGE IN HEART', '06/02/2009', 'MR. SUDHANSU');

INSERT INTO PAT_DIS VALUES ('PT001','REST FOR 6 MNTHS','OBSERVED FOR WEEK','ANTI ALLERGICS',
'275000','5/12/2009');

INSERT INTO PAT_REG VALUES ('PT001', '8/2/2009', 'STABLE', 'CONTINUE THE MEDICINE',
'PAINKILLER', 'DR001','100');
...
INSERT INTO ROOM_DETAILS VALUES ('RN001','G','N','500','100');
